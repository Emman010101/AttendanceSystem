<?php 
    ...
    if(isset($_GET['id'])){
        $student_id = $_GET['id'];
        $sql = "SELECT * FROM userstbl WHERE id=".$_GET['id'];
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group form-focus">
                                                ...
                                                <input type="text" class="form-control floating" name="firstname" value="<?php echo $data_arr[0]['firstname'];?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group form-focus">
                                                <label class="focus-label">Middle Name</label>
                                                <input type="text" class="form-control floating" name="middlename" value="<?php echo $data_arr[0]['middlename'];?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group form-focus">
                                                <label class="focus-label">Last Name</label>
                                                <input type="text" class="form-control floating" name="lastname" value="<?php echo $data_arr[0]['lastname'];?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group form-focus">
                                                ...
                                                <div class="cal-icon">
                                                    <?php
                                                        $birthdate = $data_arr[0]['birthdate'];
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group form-focus select-focus">
                                                ...
                                                <select class="select form-control floating" name="gender">
                                                    <option <?php if($data_arr[0]['gender'] == "Male") echo "selected";?>>Male</option>
                                                    <option <?php if($data_arr[0]['gender'] == "Female") echo "selected";?>>Female</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group form-focus">
                                    ...
                                    <input type="text" class="form-control floating" value="<?php echo $data_arr[0]['username'];?>" name="username">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group form-focus">
                                    <label class="focus-label">Password</label>
                                    <input type="password" class="form-control floating" name="password" id="pass">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group form-focus">
                                    <label class="focus-label">Confirm Password</label>
                                    <input type="password" class="form-control floating" id="confirm_pass">
                                </div>
                            </div>
                        </div>
                    </div>
