...
#define Finger_Rx 13 //D3
#define Finger_Tx 15 //D4
...
const char *ssid = "IMS-Wifi";
const char *password = "@cc3ssM3";
String postData; 
String link = "http://192.168.1.182/AttendanceSystem/getdata.php"; 
int FingerID = 0;     
uint8_t id;
...
void DisplayFingerprintID(){
  //Serial.println("DisplayFingerint");
  if (FingerID > 0){
    display.clearDisplay();
    display.drawBitmap( 34, 0, FinPr_valid_bits, FinPr_valid_width, FinPr_valid_height, WHITE);
    display.display();
...
void SendFingerprintID( int finger ){
  Serial.println("SendFingerprintID");
  WiFiClient client;
  HTTPClient http;  
...
uint8_t getFingerprintEnroll() {
  //Serial.println("getFingerprintEnroll");
