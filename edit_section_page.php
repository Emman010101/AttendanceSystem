<?php 
    ...
    if(isset($_GET['id'])){
        $student_id = $_GET['id'];
        $sql = "SELECT * FROM sectiontbl WHERE id=".$_GET['id'];
...
<div class="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="content">
                <div class="row">
                    <div class="col-sm-12">
                        <h4 class="page-title">Edit Grade and Section</h4>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group form-focus">
                                    ...
                                    <input type="number" class="form-control floating" name="grade" value="<?php echo $data_arr[0]['grade']?>" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group form-focus">
                                    <label class="focus-label">Section</label>
                                    <input type="text" class="form-control floating" name="section" value="<?php echo $data_arr[0]['section_name']?>" required>
                                </div>
                            </div>
                        </div>
                    </div>
