            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="add_section_page.php" class="btn btn-primary float-right btn-rounded"><i class="fa fa-plus"></i> Add Section</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
			...
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					<div class="modal-body text-center">
						...
						<h3>Are you sure want to delete this section?</h3>
						<div class="m-t-20"> <a href="#" class="btn btn-white" data-dismiss="modal">Close</a>
							<button type="submit" class="btn btn-danger" onclick="deleteSection()">Delete</button>
						</div>
					</div>
				</div>
			</div>
    ...
    <script>
        ...
        function setId(id, operation){
            ...
            if(operation == "edit_button"){
                window.location.href = "edit_section_page.php?id=" + id;
            }else{
                delete_id = id;
            }
        }
        ...
        function deleteSection(){
            window.location.href = "delete_section.php?id=" + delete_id;
        }
    </script>
</body>
</html>
